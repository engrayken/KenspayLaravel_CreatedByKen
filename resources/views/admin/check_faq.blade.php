        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-pencil7 mr-2"></i> <span class="font-weight-semibold">{{ $faq->question }}</span></h4>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.edited_faq', $faq->id) }}" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <textarea type="text" name="answer" class="tinymce form-control">{{ $faq->answer }}</textarea>
                            </div>
                        </div>
