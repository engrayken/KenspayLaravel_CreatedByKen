...
<div class="card-innr">
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="d-flex justify-content-start align-items-center w-100">
            <img style="padding-right: 8px;" id="product-image" src="{{ asset('frontend1/images/Airtime.jpg') }}" alt="Airtime Recharge Online" width="100px" height="100px" class="product-image">
            <div>
            ...
            <div class="col-xl-12">
                      ...
                      <div class="text-white"> ,</div>
                                ...
                                <label class="input-item-label">
                                    Phone Number
                                <span class="pdtsubarr" data-product-id="1" id="select-customer-billercodes" style="font-family: Roboto;font-style: normal;font-weight: 500;font-size: 11px;line-height: 9px;letter-spacing: 0.05em;color: #D50000;cursor:pointer;">
                                Select from saved Aliases
                        ...
                        <div class="col-md-6" id="aamount">
                            <div class="input-item input-with-label">
                                ...
                                <input class="input-bordered" placeholder="Enter Amount" id="amount" name="amount" type="text" required="required">
                            </div><!-- .input-item -->
                        </div>
