...
<div class="container" style="max-width: 100% !important;">
    ...
    <h2 class="page-ath-heading" style="font-weight:400;font-size:50px;color:#2c80ff;">Forgot Pass
        <small style="font-weight:300;font-size:18px;">You Forgot your password no issues</small></h2>
    <form method="POST" action="" accept-charset="UTF-8">
        ...
        <button style="border-radius:100px;" class="btn btn-primary btn-block">Retrieve Password</button>
    </form>
