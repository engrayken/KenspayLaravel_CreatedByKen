...
<div class="card-innr">
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <p class="" style="text-align:left;">
             <b class="d-flex justify-content-center align-items-center" style="font-weight:bold;color:#173D52;font-size:30px; margin-bottom:5px;"><span style="color:inherit;border-bottom:10px solid #D50000;">Terms & Conditions</span></b>
            <br>
