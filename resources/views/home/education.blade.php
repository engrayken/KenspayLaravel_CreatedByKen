                                    ...
                                    <div class="row" style="margin-top:20px;">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center w-100">
                                            <img style="padding-right: 8px;" id="product-image"
                                                src="{{ asset('frontend1/images/education.jpg') }}" alt="Education Payment"
                                                width="100px" height="100px" class="product-image">
                                            <div>
                                                <h3 style="color:#174159;"><strong>Get Instant PIN</strong></h3>
                                                <p style="">Pin - Get instant pin</p>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="input-item input-with-label">
                                                                    <label class="input-item-label">
                                                                        ...
                                                                        <span class="pdtsubarr" data-product-id="1"
                                                                            id="select-customer-billercodes"
