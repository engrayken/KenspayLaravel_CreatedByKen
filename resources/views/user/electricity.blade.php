...
<div class="card-innr">
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="d-flex justify-content-start align-items-center w-100">
            <img style="padding-right: 8px;" id="product-image" src="{{ asset('frontend1/images/electricity.jpg') }}" alt="Electricity Bills" width="100px" height="100px" class="product-image">
            <div>
                <h3 style="color:#174159;"><strong>Pay Your Electricity Bills</strong></h3>
                <p style="">Pay Your Bills</p>
            </div>
        </div>
                    ...
                    {{ Session::get('success') }}
                        ...
                        <div class="col-md-6">
                            <div class="input-item input-with-label">
                                <label class="input-item-label">Select Service</label>
...
$('#verify_loading').hide();
    ...
    $('#success').hide();
        ...
        // data: $('rate-form').serialize(),
        data:{'network':network,'phone':phone,'amount':amount,'quantity':quantity,transid,
    	'_token': $('meta[name="csrf-token"]').attr('content')},
