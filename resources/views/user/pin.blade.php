...
<div class="card-innr">
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="d-flex justify-content-start align-items-center w-100">
            <img style="padding-right: 8px;" id="product-image" src="{{ asset('frontend1/images/Airtime.jpg') }}" alt="Airtime Recharge Pin" width="100px" height="100px" class="product-image">
            <div>
                    ...
                    {{ Session::get('success') }}
                        ...
                        <div class="col-md-6">
                            <div class="input-item input-with-label">
                                ...
                                <select name="network" id="network" data-shb-product-option="data-shb-product-option" class="select select-block select-bordered selectpicker"  required="required" data-live-search="true" name="type">
                      ...
                      <div class="col-md-6">
                        <div class="input-item input-with-label">
                            ...
                            {{-- <input class="input-bordered" placeholder="Your Email" id="ex_form" name="email" type="text" value="kennethayogu@gmail.com"> --}}
                            <select name="quantity" id="quantity" data-shb-product-option="data-shb-product-option" class="select select-block select-bordered selectpicker"  required="required" data-live-search="true" name="type">
                        ...
                        <div class="col-md-6" id="aamount">
                            <div class="input-item input-with-label">
                                <label class="input-item-label">Select Denomination</label>
                                <select name="amount" id="amount" data-shb-product-option="data-shb-product-option" class="select select-block select-bordered selectpicker"  required="required" data-live-search="true" name="type">
                            ...
                            <input type="hidden" id="phone" name="phone" type="text" value="{{ $user->phone }}">

                        <div class="col-md-12">
                            <div class="gaps-1x"></div>
                            {{-- <input type="reset" value="Cancel" class="btn btn-warning"> --}}
                            <input type="submit" value="Pay" id="pay" class="btn btn-success" style="display: none">
                            <input type="submit" value="Pay" id="payd" class="btn btn-secondary" disabled>
...
$('#quantity').html('<option value="">Click To Select Network</option><option value="1">1 PCS (Check Price)</option><option value="10">10 PCS (Buy)</option><option value="30">30 PCS (Buy)</option><option value="40">40 PCS (Buy)</option><option value="60">60 PCS (Buy)</option><option value="80">80 PCS (Buy)</option><option value="100">100 PCS (Buy)</option>');
...
$.ajax({
        ...
        var fetchData=JSON.parse(data);
                ...
                {
                    output+="<option value='"+ fetchData[i].id +"'>" + fetchData[i].name +"</option>";
                }
                output+="";
          $('#amount').html("<option value=''>Select Denomination</option>"+output);
...
$('#payd').val('Pay...');
    ...
    $('#success').hide();
        ...
        // data: $('rate-form').serialize(),
        data:{'network':network,'phone':phone,'amount':amount,'quantity':quantity,'transid':transid,
    	'_token': $('meta[name="csrf-token"]').attr('content')},
