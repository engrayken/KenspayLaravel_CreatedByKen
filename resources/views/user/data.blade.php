                                    ...
                                    <div class="row" style="margin-top:20px;">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center w-100">
                                            <img style="padding-right: 8px;" id="product-image"
                                                src="{{ asset('frontend1/images/Airtime.jpg') }}" alt="Data Subscription"
                ...
                $('#network').on('change', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var output = "";
                            for (var i in fetchData) {
                                output += "<option value='" + fetchData[i].variation + "'>" +
                                    fetchData[i].name + " N" + fetchData[i].amount + "</option>";
                            }
                            output += "";
                            $('#amount').html('<option value="">Click To Select Amount</option>' +
                                output);
